    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="home"><i class="fa-solid fa-house"></i> Home</a>
            ...
            <% if(userObj != null){ %>
        <li class="nav-item">
          <a class="nav-link" href="user/addNotes">Add notes</a>
        </li>
         <li class="nav-item">
                  <a class="nav-link" href="user/viewNotes">View notes</a>
                </li>
                    <% } %>
     ...
     <% } else { %>
              <a href="#" class="btn btn-light me-2" type="submit"><i class="fa-solid fa-user"></i>${userObj.name}</a>
               <a href="user/logout" class="btn btn-light" type="submit">logout</a>
